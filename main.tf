...
# We use this to validate the KrakenD configuration file.
# https://registry.terraform.io/providers/hashicorp/null/latest/docs/resources/resource
resource "null_resource" "krakend_check" {
  triggers = {
    always_run = timestamp()
  }

  provisioner "local-exec" {
    command = "krakend check --config ${var.krakend_config_path} --test-gin-routes —debug"
  }
}

# # https://registry.terraform.io/providers/hashicorp/kubernetes/latest/docs/data-sources/namespace
